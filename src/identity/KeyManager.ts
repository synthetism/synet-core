...
export class KeyManager {
   ...
   */
  static generateKeyPair(type: KeyType): KeyPair {
    if (type === "rsa") {
   ...
   */
  static derivePublicKey(privateKey: string): string | null {
    try {
      if (
        !privateKey ||
   ...
   */
  static getShortId(publicKey: string): string {
   ...
   */
  static getFingerprint(publicKey: string): string {
